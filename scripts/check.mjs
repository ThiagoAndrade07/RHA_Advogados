...
assert.equal((html.match(/data-whatsapp-cta/g) || []).length, 6, 'Botões de contato não foram configurados');
...
console.log(`OK: ${ids.length} IDs, links locais, fontes, imagens, WhatsApp e build estático verificados.`);
